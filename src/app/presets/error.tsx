...
export default function PresetsError({
  ...
  return (
    <main className="min-h-screen w-full bg-background text-foreground px-6 pt-28 pb-20">
      <div className="mx-auto max-w-3xl border border-border bg-card/40 p-8 md:p-12 rounded-2xl text-center">
        ...
        <h1 className="text-xl md:text-2xl tracking-tight mb-2">Unable to load presets</h1>
        <p className="text-sm text-muted-foreground mb-6">
          Preset inventory failed to load. Retry to continue browsing.
        </p>
        <button
          onClick={reset}
