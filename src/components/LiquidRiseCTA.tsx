...
export default function LiquidRiseCTA({ href, className, children, ...props }: LiquidRiseCTAProps) {
  const content = (
    <>
      ...
      <div className="relative z-10 flex items-center justify-center gap-2 transition-colors duration-300 w-full h-full px-6 group-hover/cta:text-background">
        <span className="font-medium text-sm tracking-wide uppercase">{children || 'Get in touch'}</span>
