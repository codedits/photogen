      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="https://github.com/codedits" target="_blank" rel="noreferrer" aria-label="GitHub" className="flex items-center gap-3 text-sm text-[#b89dff] hover:text-white">
              <svg className="w-5 h-5 text-[#b89dff]" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
