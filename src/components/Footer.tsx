      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="mt-32 pt-8 border-t border-white/5 flex flex-col md:row items-center md:flex-row justify-between gap-6">
          <div className="flex gap-8">
            <span className="text-[9px] font-mono uppercase tracking-widest text-muted-foreground/40">© 2026 Photogen Studio</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="text-[9px] font-mono uppercase tracking-widest text-muted-foreground/40">Lahore, Pakistan</span>
          </div>
        </div>
